...
export default function DashboardTab() {
  ...
  return (
    <div className="space-y-6">
      {/* Stats */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link to="/devices" className="rounded-md border border-gray-800/40 bg-gray-900/50 p-5 hover:border-gray-700 transition-colors">
        ...
        <Link to="/sessions" className="rounded-md border border-gray-800/40 bg-gray-900/50 p-5 hover:border-gray-700 transition-colors">
